...
def main(
    ...
    ax.scatter(exp_x,exp_y, s=20, facecolors='none',label='Expected CLs', edgecolors='#686de0')
    ax.scatter(obs_x,obs_y, s=20, facecolors='none',label='Observed CLs', edgecolors='#10ac84')

    ax.plot((0, 1), linestyle='--', linewidth=1.2, c='#444444')

    ax.legend(loc='upper left', bbox_to_anchor=(-0.01, 0.90), frameon=False, fontsize=12)
    ...
    plt.text(0.04,0.92,r"$\sqrt{s}$=13 TeV, 139 fb$^{-1}$",transform = plt.gca().transAxes, alpha=1.0, fontsize=12)
